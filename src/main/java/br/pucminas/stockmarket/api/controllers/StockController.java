...
public class StockController {
	...
	public List<StockDTO> findStocksByCompany(@RequestParam(value = "Identificador da empresa para consulta de ações que estão disponiveis para a venda.", required= false) Long companyId)
	{
